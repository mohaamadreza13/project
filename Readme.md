...
telpone= input ("Masukan No Telpon Anda: ")
alamat= input ("Masukan Alamat Anda: ")


#Menampilkan Inputan User
print ("\n Assalamu'alaikum Wr.Wb. ""Let me introduce my self My name is",nama,"but you can call me",panggilan,".My NIM is",nim,"I was born in",ttl,"and I am",tl,"years old. I am very glad if you want to invite my house in",alamat,".So, don't forget to call me before with the number",telpone,"\n Terimakasih Jangan Lupa Semangat")
```
...
![Output salam](gambar/foto%203.png)
...
![Output Separator](gambar/foto%206.png)
<br>
<br>
<br>
### Pertemuan 6 - lab 1-2 
...
![Lab 1-2](gambar/foto%207.png) <br> 
``` python
#Rizky
# string format 1
print(0, 10 ** 0)
...
![Operasi Aritmatika pangkat **](gambar/foto%208.png)<br><br>
...
![OutPut Aligmnent contoh](gambar/foto%209.png)<br><br>
...
![Output Alignment](gambar/foto%2010.png)
<br>
<br>
Hasil string format 2 adalah : <br>
![Output Alignment contoh 2](gambar/foto%2011.png)
<br>
<br>
